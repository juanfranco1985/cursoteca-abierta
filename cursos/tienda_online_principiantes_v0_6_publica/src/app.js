...
function renderEmergency() {
  app.innerHTML = `
    <section class="article">
      <div class="card danger-card"><p class="eyebrow">Practica rapida</p><h1>Practica rapida del curso</h1><p class="lead">Esta vista ordena una practica breve para repasar el curso. No reemplaza fuentes oficiales, revision docente ni asesoramiento profesional.</p></div>
      <div class="card"><h2>Primeros 5 minutos</h2>${list(["Elegir un objetivo pequeno y concreto.", "Trabajar con ejemplos educativos y sin datos sensibles.", "Anotar supuestos, dudas y fuentes consultadas.", "Probar el resultado antes de compartirlo.", "Guardar una breve evidencia de aprendizaje."])}</div>
      <div class="card"><h2>Primera hora</h2>${list(["Revisar el ejemplo paso a paso y comparar con la leccion.", "Corregir errores detectados antes de avanzar.", "Probar una variante pequena del mismo ejercicio.", "Consultar una fuente confiable si aparece una duda.", "Escribir una conclusion breve con lo aprendido."])}</div>
      <div class="card"><h2>Primeras 48 horas</h2>${list(["Ordenar notas, ejemplos y resultados.", "Revisar que el resultado responda al objetivo inicial.", "Actualizar el glosario personal con conceptos nuevos.", "Preparar una mejora para la siguiente practica.", "Consultar fuentes oficiales o material especializado si corresponde."])}</div>
