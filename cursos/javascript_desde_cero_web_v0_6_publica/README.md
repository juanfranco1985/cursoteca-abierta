...
Enfoque: desarrollo web inicial con practicas pequenas, consola y codigo verificable.

Entregable sugerido: un ejemplo funcionando con una mejora propia y una nota sobre el error aprendido.
