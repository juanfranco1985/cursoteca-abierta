...
Enfoque: revision de calidad, completitud, consistencia y utilidad de datos simples.

Entregable sugerido: un reporte de calidad con reglas, problemas, prioridad, responsable y accion sugerida.
