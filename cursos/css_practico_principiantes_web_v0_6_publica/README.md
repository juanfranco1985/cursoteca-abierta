# CSS Práctico para Principiantes
...
Enfoque: estilos web responsivos, legibles y mantenibles para interfaces simples.

Entregable sugerido: una pagina estilizada con sistema basico de colores, espaciado, botones y responsive.
