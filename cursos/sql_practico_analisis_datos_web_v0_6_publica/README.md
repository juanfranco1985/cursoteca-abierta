...
Enfoque: consulta de datos con SQL para filtrar, unir, agrupar y validar informacion.

Entregable sugerido: una consulta con objetivo, SQL, resultado esperado, validacion y comentario.
