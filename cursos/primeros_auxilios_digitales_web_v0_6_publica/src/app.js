...
const emptyProgress = () => ({ lessons: [], quizzes: {}, checklistItems: [], visitedIncidents: [], triageHistory: [], updatedAt: null });
...
function renderHome() {
  ...
  app.innerHTML = `
    ...
    <section class="section grid two">
      ...
      <div class="card">
        <p class="eyebrow">Versión pública</p>
        <h2>Usar con calma y paso a paso</h2>
        <p>El curso está preparado para abrirse como sitio web, guardar progreso en este navegador y consultar rutas de emergencia sin crear cuenta.</p>
        <div class="actions"><a class="btn ghost" href="#/legal">Ver alcance y privacidad</a><a class="btn ghost" href="#/accessibility">Ajustar lectura</a></div>
      </div>
    </section>
...
function renderActionPlanCard(top, ordered = []) {
  ...
  return `
    <div class="card action-plan-card">
      <p class="eyebrow">Plan de acción v0.6</p>
...
function renderEmergencyMap() {
  ...
  app.innerHTML = `
    <section class="article">
      <div class="card danger-card">
        <p class="eyebrow">Mapa visual v0.6</p>
...
function renderPrintableChecklist() {
  ...
  app.innerHTML = `
    <section class="article printable-checklist">
      <div class="card">
        <p class="eyebrow">Checklist v0.6</p>
...
function renderTriage() {
  ...
  app.innerHTML = `
    <section class="article">
      <div class="card danger-card">
        <p class="eyebrow">Diagnóstico rápido v0.6</p>
...
function renderEmergency() {
  ...
  app.innerHTML = `
    <section class="article">
      <div class="card danger-card"><p class="eyebrow">Modo emergencia</p><h1>${esc(emergency.title || "Estoy en una emergencia digital")}</h1><p class="lead">${esc(emergency.description || "Esta guía ordena acciones urgentes. No garantiza recuperación ni reemplaza canales oficiales o asesoramiento profesional.")}</p><div class="actions"><a class="btn primary" href="#/triage">Hacer diagnóstico rápido</a><a class="btn ghost" href="#/emergency-map">Mapa de rutas</a><a class="btn ghost" href="#/print-checklist">Checklist imprimible</a></div></div>
      ...
      <div class="card"><h2>Herramientas v0.6</h2><p>Usá el mapa visual para elegir ruta o imprimí una checklist breve para actuar con menos presión.</p><div class="actions"><a class="btn primary" href="#/emergency-map">Abrir mapa visual</a><a class="btn ghost" href="#/print-checklist">Abrir checklist imprimible</a></div></div>
    </section>`;
  bindUtilityButtons(app);
...
function renderProgressTools() {
  ...
  app.innerHTML = `
    <section class="article">
      <div class="card"><p class="eyebrow">Progreso local</p><h1>Exportar, importar o reiniciar avance</h1><p>El progreso vive en este navegador. Esta pantalla ayuda a respaldarlo o reiniciarlo si querés empezar de nuevo.</p></div>
...
function renderAccessibilityTools() {
  ...
  app.innerHTML = `
    <section class="article">
      <div class="card">
        <p class="eyebrow">Accesibilidad v0.6</p>
