...
3. Revisar home, modulos, lecciones, quizzes, checklists, proyectos guiados, progreso local y constancia.
...
- El contenido es educativo y no reemplaza fuentes oficiales, revision docente ni asesoramiento profesional.
...
Enfoque: divulgacion astronomica inicial para observar, comprender y explicar fenomenos del cielo.

Entregable sugerido: una ficha de observacion con objeto, ubicacion, fuente, explicacion y pregunta abierta.
