...
Enfoque: programacion inicial con Python para leer, transformar y analizar datos simples.

Entregable sugerido: un script o notebook con entrada, limpieza, calculo, salida y explicacion.
