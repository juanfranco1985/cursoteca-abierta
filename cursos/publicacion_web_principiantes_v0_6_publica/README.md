# Publicación Web para Principiantes
...
Enfoque: preparacion y despliegue de sitios estaticos en hosting web.

Entregable sugerido: un paquete publicable con estructura, README, prueba local y URL de despliegue.
